...
export default class RideRepositoryInMemory implements IRideRepository {
  ...
  async findById(rideId: string): Promise<Ride> {
    ...
    return Ride.restore(rideData.id, rideData.passenger_id, rideData.driver_id, rideData.status_ride, rideData.request_date, rideData.accept_date, rideData.from, rideData.to, rideData.segment_id, rideData.start_date, rideData.end_date)
  }
